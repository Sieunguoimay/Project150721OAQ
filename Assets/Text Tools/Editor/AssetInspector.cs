...
namespace texttools
{
    ...
    public class AssetInspector : Editor
    {
        ...
        private SerializedProperty glyphList;
        ...
        public void OnEnable()
        {
            ...
            glyphList = serializedObject.FindProperty("glyphList");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (meshShow = EditorGUILayout.Foldout(meshShow, "Mesh"))
            {
                ...
                EditorGUILayout.PropertyField(glyphList);
                EditorGUILayout.Space();
        ...
        private void Save(Action<TextToolsFont> onSave)
        {
        ...
        private void SaveGlyphMesh(TextToolsFont asset)
        {
